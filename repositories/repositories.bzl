...
load(
    "@rules_ros2//repositories:ros2_repositories_impl.bzl",
...
def ros2_repositories():
    ...
    maybe(
        http_archive,
        name = "fmt",
        build_file = "@rules_ros2//repositories:fmt.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "spdlog",
        build_file = "@rules_ros2//repositories:spdlog.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "libyaml",
        build_file = "@rules_ros2//repositories:libyaml.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "pybind11",
        build_file = "@rules_ros2//repositories:pybind11.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "tinyxml2",
        build_file = "@rules_ros2//repositories:tinyxml2.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "console_bridge",
        build_file = "@rules_ros2//repositories:console_bridge.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:readerwriterqueue.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "sqlite",
        build_file = "@rules_ros2//repositories:sqlite.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "zstd",
        build_file = "@rules_ros2//repositories:zstd.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "lz4",
        build_file = "@rules_ros2//repositories:lz4.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "mcap",
        build_file = "@rules_ros2//repositories:mcap.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "yaml_cpp",
        build_file = "@rules_ros2//repositories:yaml_cpp.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "eigen",
        build_file = "@rules_ros2//repositories:eigen.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2",
        build_file = "@rules_ros2//repositories:ros2.BUILD.bazel",
        sha256 = "defe1f3ac6e10b17ee5aee877aa467044103fc46a7c2d74849931aa76522abc1",
        strip_prefix = "ros2-release-humble-20230614",
        urls = ["https://github.com/ros2/ros2/archive/refs/tags/release-humble-20230614.tar.gz"],
    )
    ...
    maybe(
        http_archive,
        name = "ros2_gps_umd",
        build_file = "@rules_ros2//repositories:gps_umd.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:foxglove_bridge.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "nlohmann_json",
        build_file = "@rules_ros2//repositories:nlohmann_json.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "websocketpp",
        build_file = "@rules_ros2//repositories:websocketpp.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "asio",
        build_file = "@rules_ros2//repositories:asio.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "openssl",
        build_file = "@rules_ros2//repositories:openssl.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "zlib",
        build_file = "@rules_ros2//repositories:zlib.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_xacro",
        build_file = "@rules_ros2//repositories:xacro.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "orocos_kdl",
        build_file = "@rules_ros2//repositories:orocos_kdl.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "tinyxml",
        build_file = "@rules_ros2//repositories:tinyxml.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_urdf",
        build_file = "@rules_ros2//repositories:urdf.BUILD.bazel",
        ...
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:urdf_plugin_loader_fix.patch"],
    )

    maybe(
        http_archive,
        name = "ros2_diagnostics",
        build_file = "@rules_ros2//repositories:diagnostics.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "curl",
        build_file = "@rules_ros2//repositories:curl.BUILD.bazel",
