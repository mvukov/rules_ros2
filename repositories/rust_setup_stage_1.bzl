...
def ros2_rust_repositories():
    ...
    maybe(
        ...
        sha256 = "e76f839fdc61080a352bb998defb2272d65e2482e7ef057aa97c4647f3e91f77",
        strip_prefix = "rosidl_rust-0.4.11",
        url = "https://github.com/ros2-rust/rosidl_rust/archive/refs/tags/0.4.11.tar.gz",
        patch_args = ["-p1"],
