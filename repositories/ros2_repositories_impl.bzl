...
def ros2_repositories_impl():
    maybe(
        ...
        build_file = "@rules_ros2//repositories:ament_cmake_ros.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:ament_index.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:class_loader.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:common_interfaces.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "cyclonedds",
        build_file = "@rules_ros2//repositories:cyclonedds.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_geometry2",
        build_file = "@rules_ros2//repositories:geometry2.BUILD.bazel",
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:geometry2_fix-use-after-free-bug.patch"],
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:iceoryx.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:image_common.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:kdl_parser.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:keyboard_handler.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_launch",
        build_file = "@rules_ros2//repositories:launch.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:launch_ros.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:libstatistics_collector.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:message_filters.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "osrf_pycommon",
        build_file = "@rules_ros2//repositories:osrf_pycommon.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_pluginlib",
        build_file = "@rules_ros2//repositories:pluginlib.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rcl",
        build_file = "@rules_ros2//repositories:rcl.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rcl_interfaces.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rcl_logging.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rclcpp",
        build_file = "@rules_ros2//repositories:rclcpp.BUILD.bazel",
        patch_cmds = ["patch"],
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:rclcpp_fix-maybe-uninitialized-warning.patch", "@rules_ros2//repositories/patches:rclcpp_ts_libs_ownership.patch"],
    ...
    maybe(
        http_archive,
        name = "ros2_rclpy",
        build_file = "@rules_ros2//repositories:rclpy.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rcpputils",
        build_file = "@rules_ros2//repositories:rcpputils.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rcutils",
        build_file = "@rules_ros2//repositories:rcutils.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:resource_retriever.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rmw",
        build_file = "@rules_ros2//repositories:rmw.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rmw_cyclonedds.BUILD.bazel",
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:rmw_cyclonedds-fix-typesupport-conditions-bug.patch"],
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rmw_dds_common.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rmw_implementation.BUILD.bazel",
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:rmw_implementation_library_path.patch"],
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:robot_state_publisher.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_tracing",
        build_file = "@rules_ros2//repositories:ros2_tracing.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2cli",
        build_file = "@rules_ros2//repositories:ros2cli.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:ros_testing.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rosbag2",
        build_file = "@rules_ros2//repositories:rosbag2.BUILD.bazel",
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:rosbag2_relax_plugin_errors.patch"],
    ...
    maybe(
        http_archive,
        name = "ros2_rosidl",
        build_file = "@rules_ros2//repositories:rosidl.BUILD.bazel",
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:rosidl_rm_unnecessary_asserts.patch"],
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rosidl_python.BUILD.bazel",
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:rosidl_python_fix_imports.patch"],
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rosidl_runtime_py.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:rosidl_typesupport.BUILD.bazel",
        patch_args = ["-p1"],
        patches = ["@rules_ros2//repositories/patches:rosidl_typesupport_generate_true_c_code.patch"],
    ...
    maybe(
        http_archive,
        name = "ros2_rpyutils",
        build_file = "@rules_ros2//repositories:rpyutils.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:unique_identifier_msgs.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_urdfdom",
        build_file = "@rules_ros2//repositories:urdfdom.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@rules_ros2//repositories:urdfdom_headers.BUILD.bazel",
