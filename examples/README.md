...
This is [deprecated](https://bazel.build/versions/7.5.0/external/overview#workspace-system) way of setting up external dependencies that Bazel has removed in version 9.0.0.
...
resolved dependencies in `requirements_lock.txt` file are resolved for one specific Python version.
